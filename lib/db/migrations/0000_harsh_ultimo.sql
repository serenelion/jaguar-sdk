...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "AnonymousSession" ADD CONSTRAINT "AnonymousSession_convertedUserId_User_id_fk" FOREIGN KEY ("convertedUserId") REFERENCES "public"."User"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "AnonymousSession" ADD CONSTRAINT "AnonymousSession_convertedChatId_Chat_id_fk" FOREIGN KEY ("convertedChatId") REFERENCES "public"."Chat"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
