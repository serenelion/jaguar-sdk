    ...
    const cachedFn = {
        [name]: async function(...args) {
            ...
            if (stream === undefined) {
                ...
                let entry = forceRevalidate ? undefined : 'getExpiration' in cacheHandler ? await cacheHandler.get(serializedCacheKey) : // instead of checking their staleness here, as we do for modern
